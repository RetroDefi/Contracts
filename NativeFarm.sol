...
library SafeMath {
     ...
     */
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {// SPDX-License-Identifier: MIT// SPDX-License-Identifier: MIT
...
contract NativeFarm is Ownable, ReentrancyGuard {
    ...
    // Owner reward per block: 5% ==> 6.11%
    uint256 public ownerNATIVEReward = 611;
    // Native total supply: 5 mil = 5000000e18
    uint256 public NATIVEMaxSupply = 5000000e18;
    // Natives per block: (0.475646879756478 - owner 5%)
    uint256 public NATIVEPerBlock = 428082191780822500; // NATIVE tokens created per block
    // Approx 8/3/2021
    uint256 public startBlock = 7617227; // https://bscscan.com/block/countdown/7617227
